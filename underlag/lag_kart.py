...
KREDITT = {
    ...
    'Palma_de_Mallorca,_Kathedrale_La_Seu_--_2009_--_5.jpg': ('Dietmar Rabich', 'CC BY-SA 4.0'),
    'Magnus_Colossus_tematización.JPG': ('Vicreate', 'CC BY-SA 3.0'),
    'WLM_-_2020_-_Castillo_de_Tosa_de_Mar.jpg': ('Moahim', 'CC BY-SA 4.0'),
    'View_of_Puente_Nuevo_bridge_in_Ronda_Spain.jpg': ('Wolfgang Moroder', 'CC BY-SA 3.0'),
    'Benagil_Cave_(3).jpg': ('Joseolgon', 'CC BY-SA 4.0'),
    'Skradinski_buk_waterfall_–_NP_Krka_–_2016.jpg': ('Skot', 'CC BY-SA 4.0'),
    'Knossos_R03.jpg': ('Marc Ryckaert', 'CC BY 3.0'),
    'Lindos_Acropolis_Ακρόπολη_της_Λίνδου_Rhodes_Ρόδος_2019-11-24_22.jpg': ('Manfred Werner', 'CC BY-SA 4.0'),
    'Castillo_de_Kruja,_Kruja,_Albania,_2014-04-18,_DD_16.JPG': ('Diego Delso', 'CC BY-SA 3.0'),
    'St_John_Aliturgetos_church_-_Nesebar_-_2.jpg': ('MrPanyGoff', 'CC BY-SA 3.0'),
    'Panorama_of_Malbork_Castle,_part_4.jpg': ('DerHexer', 'CC BY-SA 3.0'),
    'Latvia,_Sigulda_Turaida_castle.jpg': ('Yerachmiel C', 'CC BY-SA 4.0'),
    'Trakai_Island_16.jpg': ('Scotch Mist', 'CC BY-SA 4.0'),
    'Glencoe,_Scotland.jpg': ('Saadtowheed', 'CC BY-SA 4.0'),
    'Energylandia_-_Formuła,_Dragon_2018.jpg': ('Tomasz Adam', 'CC BY-SA 3.0'),
    'Strokkur_geyser_eruption,_close-up_view.jpg': ('Andreas Tille', 'CC BY-SA 3.0'),
    'Slovenia,_Postojna_Cave,_Postojnska_jama_(16003668035).jpg': ('Leon Yaakov', 'CC BY 2.0'),
    'Slovakia-03127_-_Korzo_(31445444404).jpg': ('Dennis G. Jarvis', 'CC BY-SA 2.0'),
    'Verona_Arena_(Arena_di_Verona).jpg': ('Kevin Poh', 'CC BY 2.0'),
    'Tallinn_Ethnografisches_Museum_Rocca_al_Mare_38.JPG': ('Zairon', 'CC BY-SA 4.0'),
    'Preikestolen-lysefjord-tunliweb.jpg': ('Svein Magne Tunli', 'CC BY-SA 4.0'),
    'RorosViewFromSlagHeaps.jpg': ('China Crisis', 'CC BY-SA 2.5'),
    'Malta_-_Ghajnsielem_-_Comino_-_Blue_Lagoon_(Comino)_01_ies.jpg': ('Frank Vincentz', 'CC BY-SA 3.0'),
    'Manavgat_waterfall_by_tomgensler.JPG': ('Thomas Gensler', 'CC BY-SA 2.0 de'),
    'Kotor_old_town_3.JPG': ('Gzzz', 'CC BY-SA 4.0'),
